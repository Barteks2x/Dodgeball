...
public class DodgeballManager implements Listener, Serializable {
    ...
    public void startMinigameDelayed(final Dodgeball m) {
        ...
        new BukkitRunnable() {
            ...
            class SendMessageTask extends BukkitRunnable {
            ...
            class StartMinigameTask extends BukkitRunnable {
                
                Dodgeball db;
                
                StartMinigameTask(Dodgeball db) {
                    this.db = db;
                }
        ...
        new BukkitRunnable() {
            public void run() {
                for(DodgeballPlayer p: pList) {
                    ...
                    if(winnerTeam != null) {
                        p.getPlayer().sendMessage(ChatColor.GOLD + "Winner team: " + winnerTeam.getChatColor() + winnerTeam.toString().toLowerCase());
                    }
                }
            }
    ...
    private class FireworkEffectTask extends BukkitRunnable {
        ...
        private final CubeSerializable c;
        private final Random rand;

        private FireworkEffectTask(Long rand, CubeSerializable cube) {
